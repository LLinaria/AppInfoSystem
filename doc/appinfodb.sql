/*
 ...
 Source Schema         : appinfodb

 Target Server Type    : MySQL
 Target Server Version : 50556
 File Encoding         : 65001

 Date: 04/06/2020 09:08:55
*/
...
CREATE TABLE `ad_promotion`  (
  ...
  `appId` bigint(30) NULL DEFAULT NULL COMMENT 'appId（来源于：app_info表的主键id）',
  `adPicPath` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '广告图片存储路径',
  `adPV` bigint(50) NULL DEFAULT NULL COMMENT '广告点击量',
  `carouselPosition` int(30) NULL DEFAULT NULL COMMENT '轮播位（1-n）',
  `startTime` datetime NULL DEFAULT NULL COMMENT '起效时间',
  `endTime` datetime NULL DEFAULT NULL COMMENT '失效时间',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于backend_user用户表的用户id）',
...
CREATE TABLE `app_category`  (
  ...
  `parentId` bigint(30) NULL DEFAULT NULL COMMENT '父级节点id',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
...
CREATE TABLE `app_info`  (
  ...
  `supportROM` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '支持ROM',
  `interfaceLanguage` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '界面语言',
  `softwareSize` decimal(20, 2) NULL DEFAULT NULL COMMENT '软件大小（单位：M）',
  `updateDate` date NULL DEFAULT NULL COMMENT '更新日期',
  `devId` bigint(30) NULL DEFAULT NULL COMMENT '开发者id（来源于：dev_user表的开发者id）',
  ...
  `flatformId` bigint(30) NULL DEFAULT NULL COMMENT '所属平台（来源于：data_dictionary，1 手机 2 平板 3 通用）',
  `categoryLevel3` bigint(30) NULL DEFAULT NULL COMMENT '所属三级分类（来源于：data_dictionary）',
  `downloads` bigint(30) NULL DEFAULT NULL COMMENT '下载量（单位：次）',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于dev_user开发者信息表的用户id）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于dev_user开发者信息表的用户id）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '最新更新时间',
  `categoryLevel1` bigint(30) NULL DEFAULT NULL COMMENT '所属一级分类（来源于：data_dictionary）',
  `categoryLevel2` bigint(30) NULL DEFAULT NULL COMMENT '所属二级分类（来源于：data_dictionary）',
  `logoPicPath` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'LOGO图片url路径',
  `logoLocPath` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'LOGO图片的服务器存储路径',
  `versionId` bigint(30) NULL DEFAULT NULL COMMENT '最新的版本id',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `app_info` VALUES (59, '机械迷城', 'com.jxmc', '3.7及更高版本', '简体中文', 77.00, '2020-05-28', 1, '              机械迷城', 1, NULL, NULL, 3, 43, 177, 1, '2020-05-26 17:45:49', 1, '2020-05-28 10:15:35', 2, 20, '/statics/uploadfiles/20180315091621_rXXvK.jpeg.jpg', 'C:\\S2\\AppInfoSystem\\target\\AppInfoSystem-1.0-SNAPSHOT\\statics\\uploadfiles\\20180315091621_rXXvK.jpeg.jpg', 59);
...
CREATE TABLE `app_version`  (
  ...
  `publishStatus` bigint(30) NULL DEFAULT NULL COMMENT '发布状态（来源于：data_dictionary，1 不发布 2 已发布 3 预发布）',
  ...
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于dev_user开发者信息表的用户id）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '最新更新时间',
  `apkLocPath` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT 'apk文件的服务器存储路径',
  `apkFileName` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '上传的apk文件名称',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `app_version` VALUES (57, 59, 'V1.1.1', '                            V1.1.1版本', 3, '/statics/uploadfiles/com.bithack.apparatus-V1.1.1.apk', 17.00, 1, '2020-05-29 09:35:08', 1, '2020-05-29 12:06:57', 'C:\\S2\\AppInfoSystem\\target\\AppInfoSystem-1.0-SNAPSHOT\\statics\\uploadfiles\\com.bithack.apparatus-V1.1.1.apk', 'com.bithack.apparatus-V1.1.1.apk');
INSERT INTO `app_version` VALUES (58, 59, 'V1.1.2', 'V1.1.2简介', 3, '/statics/uploadfiles/com.doodleapps.powdertoy-V1.1.2.apk', 27.00, 1, '2020-05-29 12:25:01', NULL, '2020-05-29 12:25:01', 'C:\\S2\\AppInfoSystem\\target\\AppInfoSystem-1.0-SNAPSHOT\\statics\\uploadfiles\\com.doodleapps.powdertoy-V1.1.2.apk', 'com.doodleapps.powdertoy-V1.1.2.apk');
INSERT INTO `app_version` VALUES (59, 59, 'V1.1.3', '              V1.1.3', 3, '/statics/uploadfiles/com.doodleapps.powdertoy-V1.1.3.apk', 37.00, 1, '2020-05-29 12:26:48', 1, '2020-06-02 15:25:19', 'C:\\S2\\AppInfoSystem\\target\\AppInfoSystem-1.0-SNAPSHOT\\statics\\uploadfiles\\com.doodleapps.powdertoy-V1.1.3.apk', 'com.doodleapps.powdertoy-V1.1.3.apk');
...
CREATE TABLE `backend_user`  (
  ...
  `userType` bigint(30) NULL DEFAULT NULL COMMENT '用户角色类型（来源于数据字典表，分为：超管、财务、市场、运营、销售）',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于backend_user用户表的用户id）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '最新更新时间',
...
-- ----------------------------
INSERT INTO `backend_user` VALUES (1, 'admin', '系统管理员', 1, 1, '2016-08-20 00:13:41', NULL, NULL, 'e10adc3949ba59abbe56e057f20f883e');
...
CREATE TABLE `data_dictionary`  (
  `id` bigint(30) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `typeCode` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '类型编码',
  `typeName` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '类型名称',
  `valueId` bigint(30) NULL DEFAULT NULL COMMENT '类型值ID',
  `valueName` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '类型值Name',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于backend_user用户表的用户id）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '最新更新时间',
...
CREATE TABLE `dev_user`  (
  ...
  `devEmail` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '开发者电子邮箱',
  `devInfo` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '开发者简介',
  `createdBy` bigint(30) NULL DEFAULT NULL COMMENT '创建者（来源于backend_user用户表的用户id）',
  `creationDate` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `modifyBy` bigint(30) NULL DEFAULT NULL COMMENT '更新者（来源于backend_user用户表的用户id）',
  `modifyDate` datetime NULL DEFAULT NULL COMMENT '最新更新时间',
...
-- Records of dev_user
-- ----------------------------
INSERT INTO `dev_user` VALUES (1, 'test001', '测试账户001', 'e10adc3949ba59abbe56e057f20f883e', NULL, NULL, 1, '2016-08-20 00:13:41', NULL, NULL);
